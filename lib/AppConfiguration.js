...
const { setRelayProxyConfigured } = require('./core/ApiManager');
...
const AppConfiguration = () => {
  ...
  return {
    ...
    /**
     * Configures this SDK to connect to relay proxy
     * @param {string} url - the base url of relay proxy
     */
    setRelayProxyEndpoint: (url) => {
      if (url) {
