...
const ConfigurationHandler = () => {
    ...
    function createInstance({
        ...
        function storeFiles() {
            const result = FileManager.getFileData(configurationFile);
        ...
        async function fetchFromAPI() {
            try {
                const urlForAllConfigurations = urlBuilder.getConfigUrl(collectionId);
        ...
        function fetchConfigurationFromFileActions(localConfigurationFilePath) {
            _liveUpdate = false
            configurationFile = localConfigurationFilePath
        ...
        function recordEvaluation(featureId, propertyId, identityId, segmentId) {
            meteObj.addMetering(guid, collectionId, identityId, segmentId, featureId, propertyId)
        }
        ...
        return {
            ...
            featureEvaluation,
            propertyEvaluation,
            fetchConfigurationFromFileActions,
            getConfig,
            cleanup
        }
    }
