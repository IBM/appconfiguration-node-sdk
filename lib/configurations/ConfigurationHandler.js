      ...
      try {
        ...
        if (feature.enabled) {
          if (feature.experiment && feature.experiment.experiment_status === 'RUNNING') {
            ...
            const trafficDistribution = feature.experiment.traffic_distribution_json;
            ...
            if (trafficDistribution.type === 'ALL') {
              ...
              for (const v of variations) {
                if (variationId === v.variation_id) {
                  ...
                  resultDict.details.reason = reasonExperimentVariation_y(entityId, audienceGroup, v.variation_name);
