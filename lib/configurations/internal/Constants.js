...
const Constants = {
    ...
    COLLECTION_INIT_ERROR: "Invalid action in App Configuration. This action can be performed only after a successful initialization and set collectionId value operation. \n Please check the initialization and setCollectionId sections for errors.",
    ...
    LIVE_CONFIGURATION_UPDATE_PARAMETER_WARNING: "Local configurationFile provided has no effect when liveConfigUpdateEnabled is set to true.",
