...
const reasonExperimentVariation_y = (entityId, audienceGroup, variationId) => `Experiment is running. The entityId '${entityId}' is part to experiment audience and belongs ${audienceGroup} group. The evaluated value corresponds to variation: ${variationId}.`
