...
const reasonSegmentValueProperty = (segmentName) => `Segment value of the property since entityAttributes satisfies the ${segmentName} segment rules.`;
...
// Evaluation reasons for experimentation
const reasonExperimentVariation_y = (entityId, audienceGroup, variationName) => `Experiment is running. The entityId '${entityId}' is part to experiment audience and belongs ${audienceGroup} group. The evaluated value corresponds to variation: ${variationName}.`
const reasonExperimentVariation_n = (entityId) => `Experiment is running. The entityId '${entityId}' is not part of experiment audience. The evaluated value corresponds to enabled or disabled or overridden value of the feature flag based on further evaluation.`
